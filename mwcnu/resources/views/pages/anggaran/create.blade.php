...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <form action="/anggaran" method="POST" class="needs-validation" novalidate>
                @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="jadwal_proker_id" id="jadwal_proker_id"
                                class="form-control @error('jadwal_proker_id') is-invalid @enderror">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="catatan" id="catatan" rows="3" class="form-control @error('catatan') is-invalid @enderror"></textarea>
                            @error('catatan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
