...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    <div class="bg-white p-6 rounded-2xl shadow-md space-y-6">
        ...
        <div class="text-center">
            <h1 class="text-2xl font-bold text-gray-800">Buat Program Kerja MWC</h1>
        ...
        <form action="{{ route('proker-mwc.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
            ...
            {{-- Dropdown Dinamis Bidang / Jenis / Tujuan / Sasaran --}}
            @foreach ([['bidang_id','Bidang',$bidangs,'new_bidang'],
                       ['jenis_id','Jenis Kegiatan',$jenisKegiatans,'new_jenis'],
                       ['tujuan_id','Tujuan',$tujuans,'new_tujuan'],
                       ['sasaran_id','Sasaran',$sasarans,'new_sasaran']] 
                       as [$field,$label,$list,$newField])
                ...
                <div>
                    ...
                    <input type="text" name="{{ $newField }}" id="{{ $newField }}"
                        ...
                        value="{{ old($newField) }}"
                        class="w-full px-4 py-2 border rounded-lg shadow-sm mt-2 focus:ring-green-500 focus:border-green-500
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="4"
                    class="w-full px-4 py-2 border rounded-lg shadow-sm resize-y
                        focus:ring-green-500 focus:border-green-500">{{ old('deskripsi') }}</textarea>
            </div>
